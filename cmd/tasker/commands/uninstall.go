...
// 	uninstallCmd.Flags().StringVar(&uninstallArgs.uiName, "ui-name", KubeUIDeploymentName, "name of ui deployment")
...
// 	err := svcClient.Delete(context.TODO(), KubeUIServiceName, &metav1.DeleteOptions{})
// 	if err != nil {
// 		if !apierr.IsNotFound(err) {
// 			log.Fatalf("Failed to delete service '%s': %v", KubeUIServiceName, err)
// 		}
// 		fmt.Printf("Service '%s' in namespace '%s' not found\n", KubeUIServiceName, uninstallArgs.namespace)
// 	} else {
// 		fmt.Printf("Service '%s' deleted\n", KubeUIServiceName)
// 	}

// 	// Delete the UI and workflow-controller deployment
// 	deploymentsClient := clientset.
// beta2().Deployments(uninstallArgs.namespace)
...
// 	err = cmClient.Delete(context.TODO(), uninstallArgs.configMap, &metav1.DeleteOptions{})
// 	if err != nil {
// 		if !apierr.IsNotFound(err) {
...
// 	for _, bindingName := range []string{KubeTaskerControllerClusterRole, KubeUIClusterRoleBinding} {
...
// 	for _, roleName := range []string{KubeTaskerControllerClusterRole, KubeUIClusterRole} {
// 		if err := clientset.RbacV1().ClusterRoles().Delete(context.TODO(), roleName, &metav1.DeleteOptions{}); err != nil {
// 			if !apierr.IsNotFound(err) {
...
// 	for _, serviceAccount := range []string{KubeTaskerControllerServiceAccount, KubeUIServiceAccount} {
