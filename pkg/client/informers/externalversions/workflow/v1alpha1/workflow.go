...
import (
	...
	workflowv1alpha1 "github.com/kubeTasker/kubeTasker/pkg/apis/workflow/v1alpha1"
	versioned "github.com/kubeTasker/kubeTasker/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kubeTasker/kubeTasker/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kubeTasker/kubeTasker/pkg/client/listers/workflow/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeTaskerV1alpha1().Workflows(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeTaskerV1alpha1().Workflows(namespace).Watch(context.TODO(), options)
			},
		},
