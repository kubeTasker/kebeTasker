...
var workflowsResource = schema.GroupVersionResource{Group: "kubeTasker.io", Version: "v1alpha1", Resource: "workflows"}

var workflowsKind = schema.GroupVersionKind{Group: "kubeTasker.io", Version: "v1alpha1", Kind: "Workflow"}
